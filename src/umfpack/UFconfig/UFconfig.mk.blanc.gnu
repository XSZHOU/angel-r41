...
CC 	= mpcc -compiler gcc

# alternatives:
CFLAGS 	= -q64 -O3 -fexceptions -Wall -Wno-unknown-pragmas
...
F77 	 = mpfort -compiler gfortran
#F77FLAGS = -q64 -O1 ffef -Wall 
#F77LIB  = -lgfortran -lxlf90
F77FLAGS = -q64 -O1 ffef -Wall 
F77LIB  = 

# C libraries;
#LIB = -L/opt/ibmcmp/xlf/11.1/lib64 -lxlf90_r -lxlfmath -L/opt/ibmcmp/xlsmp/1.7/lib64 -lxlomp_ser -L/usr/lib64/ -lmpi_ibm 
#LIB = -L/opt/ibmcmp/xlf/11.1/lib64 -lxlf90_r -lxlfmath -L/opt/ibmcmp/xlsmp/1.7/lib64 -lxlomp_ser
LIB = 
...
# <ss> please also check below for the NO_UNDERSCORE flag
#BLAS   = /apps/lapack/3.1.1/XL/lib/blas_ppc64.a
#LAPACK = /apps/lapack/3.1.1/XL/lib/lapack_ppc64.a
BLAS   = /apps/lapack/3.1.1/GNU/blas_ppc64.a
LAPACK = /apps/lapack/3.1.1/GNU/lapack_ppc64.a
...
# <ss> XL blanc blas/lapack is w/o underscore!
#UMFPACK_CONFIG = -DBLAS_NO_UNDERSCORE
UMFPACK_CONFIG =
