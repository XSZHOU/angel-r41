...
# ALREADY PROVIDED BY PURDUE:
# CC 	= mpcc -compiler gcc

# alternatives:  modified by S.Z.
CFLAGS 	= -fPIC -O3 -fexceptions -Wall -Wno-unknown-pragmas -DMKL_ILP64 -I${MKL_INC}
...
F77 	 = $(FC)
F77FLAGS = -O1 ffef -Wall  -fPIC
F77LIB  = 

# C libraries;
# modified by S,Z. Intel MKL do not need -> -llapack -lblas -lm
LIB = -L${MKL_LIB}  -lmkl_intel_ilp64 -lmkl_intel_ilp64 -lmkl_core -lmkl_sequential -lpthread -lm
